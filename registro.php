            ...
            <div class="container">
              ...
              <form action="save.php" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" >
                                      <select class="select2_single form-control" tabindex="-1" name="ciudad">
                                        <option></option>
                            ...
                            <fieldset>
                                    ...
                                    <input type="text" name="usuario" class="form-control" placeholder="Ingrese un nickname"/>
                                </div>
                                <div class="form-group">
                                    <label>Pin de Usuario:</label>
                                    <input type="password" name="pin" class="form-control" placeholder="Ingrese un pin de cuatro digitos"/>
                                </div>
                                <div class="wizard-buttons">
                                    <button type="button" class="btn btn-previous">Anterior</button>
                                    <button type="button" class="btn btn-next">Siguiente</button>
