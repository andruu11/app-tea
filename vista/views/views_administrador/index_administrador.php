        ...
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item d-md-down-none">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="#">
                        <i class="fa fa-tasks"></i> Articulos
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="../../../modelo/log_out.php"><i class="fa fa-lock"></i> Cerrar sesión</a>
                </div>
            </li>
        </ul>
    </header>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="i#"><i class="icon-wallet"></i> Administradores</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-notebook"></i> Tutores</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-notebook"></i> Familiares</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../../modelo/log_out.php"><i class="fa fa-lock"></i> Cerrar Sesión</a>
                    </li>
